...
const { clockString, parseMention, formatp, tanggal, getTime, isUrl, sleep, runtime, fetchJson, getBuffer, jsonformat, format, reSize, generateProfilePicture, getRandom } = require('./lib/lib')
const { color, bgcolor } = require('./lib')
const { fetchBuffer, buffergif } = require("./lib")
const { rentfromxeon, conns } = require('./lib')
const { uptotelegra } = require('./scrape/upload')
const { msgFilter } = require('./lib/antispam')

const { ytDonlodMp3, ytDonlodMp4, ytPlayMp3, ytPlayMp4, ytSearch } = require('./scrape/yt')
const anon = require('./lib') 
const scp1 = require('./lib') 
const scp2 = require('./lin')
const scp3 = require('./lib')
const { XeonInstaMp4 } = require('./lib')
