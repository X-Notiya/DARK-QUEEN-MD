...
*🦑⃝🧚‍♀️ Total Stars:* ${data.stargazers_count} stars
*🦑⃝🧚‍♀️ Forks:* ${data.forks_count} forks
*🦑⃝🧚‍♀️ Repo:* 
●➣
...
cmd({
    ...
    async(Void, citel) => {
        ...
        let ter = `
🔰 *${tlang().title}* 🔰
*🦑⃝🧚‍♀️🌟Description:* A WhatsApp bot with rich features, build in NodeJs to make your WhatsApp enjoyable.
*🦑⃝🧚‍♀️⚡Speed:* ${latensie.toFixed(4)} ms
*🦑⃝🧚‍♀️🚦Uptime:* ${runtime(process.uptime())}
*🦑⃝🧚‍♀️🕸Version:* 1
*🦑⃝🧚‍♀️👤Owner:*  ${Config.ownername}
*🦑⃝🧚‍♀️Powered by ${tlang().title}*
`;
        let buttonMessaged = {
            image: {
                url: await botpic(),
...
str+=`1. SECKTOR\n2. ADAM\n3. AYANOKOJI\n4. EDITH\n5. FRIDAY\n6. GENOS\n7. GIDEON\n8. GOKU\n9. LUFFY\n10. NARUTO\n11. NEZUKO\n12. PARKER\n13. ZEROTWO\n14. Eren Jeager(Coming Soon)\n\n these are the themes of Sector Userbot.\_Reply ${prefix}setvar THEME:ZEROTWO`
