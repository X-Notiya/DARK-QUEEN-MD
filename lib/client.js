...
try {
    ...
    console.log("🌍 Connected to the Queen Nethu MD")
} catch {
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    for (let i of owner) {
                        Void.sendMessage(i + "@s.whatsapp.net", { text: `┏─────────────────⬣\n┆ _🧚‍♂️Qᴜᴇᴇɴ ɴᴇᴛʜᴜ ᴍᴅ ʜᴀꜱ ʙᴇᴇɴ ɪɴᴛᴇɢʀᴀᴛᴇᴅ🧚‍♂️._\n┆ _💕Total Plugins : ${events.commands.length}_\n┆ _🎀Mode: ${Config.WORKTYPE}_\n┆ _🙈Version:- 0.0.5_\n┆ _❥Branch:- ${Config.BRANCH}_\n┆ _🎊Theme: ${Config.LANG}_\n┆ _🧛Owner:- ${process.env.OWNER_NAME}_\n┗┬──────────────┈ ⳹\n┏┤   Devoloper Info\n┆┗──────────────┈ ⳹\n┆♠︎ 𝗡𝗮𝗺𝗲 :ᴍʀ.ʜᴀɴꜱᴀᴍᴀ\n│♠︎ 𝗡𝘂𝗺𝗯𝗲𝗿 : 94781708673\n│♠︎ 𝗣𝗿𝗲𝗺𝗶𝘂𝗺 : ✅\n┗┬──────────────┈\n` })
                    }
                }
