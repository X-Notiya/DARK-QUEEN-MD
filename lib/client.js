...
try {
    ...
    console.log("🍁 CONNECTING TO 𝐃𝚫𝚪𝐊 𝐐𝐔𝚵𝚵𝚴 𝚳𝐃🍁")
} catch {
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "https://telegra.ph/file/2410f13a9a02224c996af.jpg"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "https://telegra.ph/file/2410f13a9a02224c996af.jpg"); //ur logo pic
...
`.trim());
                ...
                console.log(e)
             //   await Void.sendMessage('94715491788@s.whatsapp.net',{text: util.format(mek)})
               // await Void.sendMessage('94715491788@s.whatsapp.net',{text: util.format(e)})
            }
        })
 const { sck } = require('.')
...
await updateStatus()
 ...
 Void.ev.on('group-participants.update', async(anu) => {
            try {
                ...
                for (let num of participants) {
                    ...
                    try {
                        ...
                        ppuser = 'https://telegra.ph/file/2410f13a9a02224c996af.jpg'
                    }
                    if (Config.antifake != '') {
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            try {
                                ...
                                ppurl = 'https://telegra.ph/file/2410f13a9a02224c996af.jpg'
                            }
                            let buttonMessage = {
                                image: {url : ppUrl },
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    console.log("✅ Login Successful𝐃𝚫𝚪𝐊 𝐐𝐔𝚵𝚵𝚴!");
                    console.log("⬇️  Installing External Plugins...𝐃𝚫𝚪𝐊 𝐐𝐔𝚵𝚵𝚴 𝚳𝐃");
                    ...
                    console.log("✅  External Plugins Installed𝐃𝚫𝚪𝐊 𝐐𝐔𝚵𝚵𝚴 𝚳𝐃!");
