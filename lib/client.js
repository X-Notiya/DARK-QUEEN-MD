...
try {
    ...
    console.log("🌍 CONNECTING TO 🍁𝐷𝛥𝑅𝛫 𝑄𝑈𝛯𝛯𝛮 𝛭𝐷🍁 DATABASE")
} catch {
...
let cc = Config.sessionName.replace(/CHAMOD-MD;;;/g, "");
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === "connecting") {
                   console.log("ℹ️ Connecting to 🍁𝐷𝛥𝑅𝛫 𝑄𝑈𝛯𝛯𝛮 𝛭𝐷🍁WhatsApp... Please Wait.");
                }
                if (connection === 'open') {
                    console.log("✅ Login Successful!DARK-QUEEN-MD");
                    console.log("⬇️  Installing External Plugins...DARK-QUEEN-MD");
                    ...
                    console.log("✅  External Plugins Installed!🍁DARK-QUEEN-MD🍁");
