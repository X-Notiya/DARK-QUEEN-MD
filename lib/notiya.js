...
try {
    ...
    console.log("🌍 Connected to the DARK-QUEEN-MD")
} catch {
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const ChangePic = __dirname + "https://telegra.ph/file/85d754568883e4b77bfdd.jpg"
        await writeFile(ChangePic, thumbbuffer);
        global.log0 = fs.readFileSync(__dirname + "https://telegra.ph/file/85d754568883e4b77bfdd.jpg"); //ur logo pic
 ...
 Void.ev.on('group-participants.update', async(anu) => {
            try {
                ...
                for (let num of participants) {
                    ...
                    try {
                        ...
                        ppuser = 'https://telegra.ph/file/85d754568883e4b77bfdd.jpg'
                    }
                    if (Config.antifake != '') {
                        ...
                        if(/@pp/g.test(goodbye_messages)) {
                           let buttonMessage = {
                            ...
                            try {
                                ...
                                ppurl = 'https://telegra.ph/file/85d754568883e4b77bfdd.jpg'
                            }
                            let buttonMessage = {
                                image: {url : ppUrl },
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === "connecting") {
                   console.log("ℹ️ Connecting to WhatsApp... Please Waitපරීක්ශා කරමින්🙂.");
                }
                if (connection === 'open') {
                    console.log("✅ Login Successfulහරි සම්බන්ද උන!");
